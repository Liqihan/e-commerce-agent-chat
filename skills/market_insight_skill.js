...
function generateCompetitorStrengths(competitor) {
  // 模拟生成竞争对手优势
  const strengths = [
    "品牌知名度高",
    "产品质量可靠",
...
function generateCompetitorWeaknesses(competitor) {
  // 模拟生成竞争对手劣势
  const weaknesses = [
    "产品更新速度慢",
    "客户反馈响应不及时",
...
function generateOpportunities(category) {
...
function generateThreats(category) {
  const threatsMap = {
    "服装": [
      "快时尚品牌竞争",
      "原材料价格波动",
